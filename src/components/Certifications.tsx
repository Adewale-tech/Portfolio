        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-slate dark:text-light-slate mb-4">
              This intensive program delivered comprehensive expertise in backend development, covering scalable and secure systems. Key competencies developed include:
            </p>
